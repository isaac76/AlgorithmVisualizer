...
template<class C> class Set : public Collection<C> {
private:
...
public:
    ...
    // Set operations
    static void unionSet(Set<C>* result, const Set<C>* set1, const Set<C>* set2) {
        SetNode<C>* current;
    ...
    static void intersectionSet(Set<C>* result, const Set<C>* set1, const Set<C>* set2) {
        SetNode<C>* current;
    ...
    static void differenceSet(Set<C>* result, const Set<C>* set1, const Set<C>* set2) {
        SetNode<C>* current;
    ...
    static bool isSubset(const Set<C>* set1, const Set<C>* set2) {
        SetNode<C>* current;
    ...
    static bool isEqualSet(const Set<C>* set1, const Set<C>* set2) {
